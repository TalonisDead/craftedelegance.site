...
final class PW_On_Sale {
    ...
    function ajax_save_sale() {
        check_ajax_referer( 'pw-on-sale-create', 'security' );
    ...
    function ajax_sale_delete() {
        check_ajax_referer( 'pw-on-sale-delete', 'security' );
    ...
    function admin_enqueue_scripts( $hook ) {
        ...
        if ( !empty( $hook ) && substr( $hook, -strlen( 'pw-on-sale' ) ) === 'pw-on-sale' ) {
            ...
            wp_localize_script( 'pw-on-sale-script', 'pwos', array(
                'nonces' => array(
                    'create_sale' => wp_create_nonce( 'pw-on-sale-create' ),
                    'delete_sale' => wp_create_nonce( 'pw-on-sale-delete' ),
                )
            ) );
        }
